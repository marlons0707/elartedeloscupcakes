  ...
  */
  head: {
    ...
    meta: [
      ...
      { name: 'msapplication-TileImage', content: '/elartedeloscupcakes/favicons/ms-icon-144x144.png' },
      // PWA primary color
    ...
    link: [
      // Favicon
      { rel: 'shortcut icon', href: '/elartedeloscupcakes/favicons/favicon.ico' },
      { rel: 'apple-touch-icon', sizes: '57x57', href: '/elartedeloscupcakes/favicons/apple-icon-57x57.png' },
      { rel: 'apple-touch-icon', sizes: '60x60', href: '/elartedeloscupcakes/favicons/apple-icon-60x60.png' },
      { rel: 'apple-touch-icon', sizes: '72x72', href: '/elartedeloscupcakes/favicons/apple-icon-72x72.png' },
      { rel: 'apple-touch-icon', sizes: '76x76', href: '/elartedeloscupcakes/favicons/apple-icon-76x76.png' },
      { rel: 'apple-touch-icon', sizes: '114x114', href: '/elartedeloscupcakes/favicons/apple-icon-114x114.png' },
      { rel: 'apple-touch-icon', sizes: '120x120', href: '/elartedeloscupcakes/favicons/apple-icon-120x120.png' },
      { rel: 'apple-touch-icon', sizes: '144x144', href: '/elartedeloscupcakes/favicons/apple-icon-144x144.png' },
      { rel: 'apple-touch-icon', sizes: '152x152', href: '/elartedeloscupcakes/favicons/apple-icon-152x152.png' },
      { rel: 'apple-touch-icon', sizes: '180x180', href: '/elartedeloscupcakes/favicons/apple-icon-180x180.png' },
      { rel: 'icon', type: 'image/png', sizes: '192x192', href: '/elartedeloscupcakes/favicons/android-icon-192x192.png' },
      { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/elartedeloscupcakes/favicons/favicon-32x32.png' },
      { rel: 'icon', type: 'image/png', sizes: '96x96', href: '/elartedeloscupcakes/favicons/favicon-96x96.png' },
      { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/elartedeloscupcakes/favicons/favicon-16x16.png' },
      { rel: 'manifest', href: '/elartedeloscupcakes/favicons/manifest.json' },
      // Fonts and Icons
